...
import { getAll, login, logout, logoutAll, mailtest, me, register, registerStaff, remove, resetpassword, sendOTP, socialSuccess, updateOwn, updateUser, userProfile, verifyOTP } from './user.entity';
